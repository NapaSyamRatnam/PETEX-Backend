...
public class UserEntity {
	...
	private List<PetshowEntity> petshow;
	public UserEntity() {
		super();
	...
	public UserEntity(Long userId, String petType, String petname, String species, Integer age, String gender,
			...
			String email, String pwd, String confirmPwd, Long phno, String city, String otp, Long cart,
			List<PetshowEntity> petshow) {
		super();
		this.userId = userId;
	...
	public List<PetshowEntity> getPetshow() {
		return petshow;
	}
	...
	public void setPetshow(List<PetshowEntity> petshow) {
		this.petshow = petshow;
	}
